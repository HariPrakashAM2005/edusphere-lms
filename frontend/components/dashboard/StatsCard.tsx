...
interface StatsCardProps {
  ...
  suffix?: string;
  icon: LucideIcon;
  gradient?: 'blue' | 'green' | 'orange' | 'purple' | 'teal' | 'pink';
  trend?: {
    value: number;
    isPositive: boolean;
  };
...
export default function StatsCard({
  ...
  const gradientClasses = {
    ...
    green: 'from-emerald-400 to-teal-500 text-white shadow-emerald-500/20',
    orange: 'from-orange-400 to-amber-500 text-white shadow-orange-500/20',
    purple: 'from-purple-500 to-fuchsia-600 text-white shadow-purple-500/20',
    teal: 'from-teal-400 to-cyan-500 text-white shadow-teal-500/20',
    pink: 'from-pink-500 to-rose-600 text-white shadow-pink-500/20',
  };
  ...
  return (
    <Card hoverLift className="p-6 flex items-center relative overflow-hidden border border-gray-150/40 dark:border-gray-800/40">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[10px] md:text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider truncate">
          {title}
        </p>
