...
const badge_service_1 = require("../src/modules/gamification/badge.service");
const reward_service_1 = require("../src/modules/gamification/reward.service");
const prisma = new client_1.PrismaClient();
async function main() {
    const passwordHash = bcryptjs_1.default.hashSync('Test@123', 10);
    // Seed Student
    ...
    await (0, reward_service_1.seedDefaultRewards)();
