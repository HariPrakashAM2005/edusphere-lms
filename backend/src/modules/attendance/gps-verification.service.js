...
exports.detectSpoofing = exports.verifyLocation = void 0;
 ...
 */
const verifyLocation = (studentLat, studentLon, classLat, classLon, headers // check headers for potential spoofing clues
) => {
    // 1. Validation
    if (!(0, geo_utils_1.isValidCoordinate)(studentLat, studentLon)) {
        return {
            verified: false,
            distance: -1,
    ...
    if (!(0, geo_utils_1.isValidCoordinate)(classLat, classLon)) {
        return {
            verified: false,
            distance: -1,
            spoofingDetected: false,
    ...
    const spoofingDetected = (0, exports.detectSpoofing)(studentLat, studentLon, headers);
    if (spoofingDetected) {
        return {
            verified: false,
            distance: -1,
    ...
    const distance = (0, geo_utils_1.calculateDistance)(studentLat, studentLon, classLat, classLon);
 ...
 */
const detectSpoofing = (lat, lon, headers) => {
    if (!headers)
        return false;
...
exports.detectSpoofing = detectSpoofing;
