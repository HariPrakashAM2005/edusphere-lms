...
exports.awardXP = exports.getLevelFromXP = exports.getXPForLevel = void 0;
...
const getLevelFromXP = (totalXP) => {
    let level = 1;
    while (totalXP >= (0, exports.getXPForLevel)(level + 1)) {
        level++;
    }
    return level;
};
 ...
 */
const awardXP = async (userId, action, baseAmount, sourceId, multiplier = 1.0) => {
    ...
    return await prisma.$transaction(async (tx) => {
        ...
        const newLevel = (0, exports.getLevelFromXP)(newTotalXP);
        const leveledUp = newLevel > oldLevel;
        // Remaining XP in current level
        const xpNeededForNewLevelStart = (0, exports.getXPForLevel)(newLevel);
 ...
 */
const updateLeaderboardScore = async (tx, userId, xpAmount) => {
 ...
 */
const updateQuestProgress = async (tx, userId, action) => {
    ...
    if (progress) {
        ...
        if (completed) {
            ...
            if (userLevelObj) {
                ...
                const questNewLevel = (0, exports.getLevelFromXP)(questTotalXP);
                const questNewLevelStart = (0, exports.getXPForLevel)(questNewLevel);
