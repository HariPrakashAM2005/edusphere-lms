...
exports.explainConcept = exports.generateFlashcards = exports.generateAssignment = exports.summarizeTranscript = exports.generateQuizFromPDF = void 0;
...
const generateQuizFromPDF = async (pdfText, questionCount = 5, difficulty = 'medium', createdBy) => {
    if (OPENAI_API_KEY) {
        try {
...
const summarizeTranscript = async (transcript, createdBy) => {
    if (OPENAI_API_KEY) {
        try {
            const response = await axios_1.default.post(OPENAI_API_URL, {
                model: 'gpt-4o',
...
const generateAssignment = (topic) => {
...
const generateFlashcards = (lessonContent) => {
...
// 5. explainConcept
const explainConcept = (concept, style = 'simple') => {
