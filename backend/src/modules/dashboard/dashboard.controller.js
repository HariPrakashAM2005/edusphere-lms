...
exports.getUpcomingDeadlines = exports.completeLesson = exports.getCourseDetails = exports.getEnrolledCourses = exports.getLearningProgress = exports.getStudentStats = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
// User-specific mock storage
const userCourses = new Map();
const userCourseDetails = new Map();
const userXpProgress = new Map();
const userDeadlines = new Map();
const userStreaks = new Map(); // user id -> streak count
// Initialize data helper
const initUserDashboardData = (userId) => {
